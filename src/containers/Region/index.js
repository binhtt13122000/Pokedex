...
import { convertHyPhenStringToNormalString, convertNormalStringToHyphenString, getFrontDefaultImage, getOrder } from '../../utils/function';
...
export const Region = () => {
    ...
    return <Container>
            ...
            <Grid item xs={12} md={4}>
                <Paper elevation={3} className={classes.paperMap}>
                    <Container>
                        ...
                        <Image width="60%" height="auto" className={classes.banner} src={regionImg.map} alt={regionImg.map} />
        ...
        <Grid container alignItems="center">
            ...
            <Grid item xs={12} md={4}>
                <TextField fullWidth placeholder="Find Poke..." variant="outlined" size="small" value={search} onChange={e => setSearch(e.target.value)}/>
            </Grid>
        </Grid>
        <Grid container>
            {selectedPokedex.listPoke && selectedPokedex.listPoke.filter(poke => poke.name.includes(convertNormalStringToHyphenString(search))).map((poke, index) => {
